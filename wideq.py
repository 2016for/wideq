...
class WASHERRINSEOPTION(enum.Enum):
    ...
    RINSE_PLUS_PLUS = "@WM_TITAN2_OPTION_RINSE_RINSE++_W"
    NORMAL = "@WM_TITAN2_OPTION_RINSE_NORMAL_W"
    NORMALHOLD = "@WM_TITAN2_OPTION_RINSE_NORMALHOLD_W"
    RINSE_PLUS = "@WM_TITAN2_OPTION_RINSE_RINSE+_W"
    RINSE_PLUS_HOLD = "@WM_TITAN2_OPTION_RINSE_RINSE+HOLD_W"

class WASHOPTION(enum.Enum):
    
    NORMAL = "@WM_TITAN2_OPTION_WASH_NORMAL_W"
    TURBO_WASH = "@WM_TITAN2_OPTION_TURBO_WASH_W"
    INTENSIVE = "@WM_TITAN2_OPTION_WASH_INTENSIVE_W"
    TIMESAVE = "@WM_TITAN2_OPTION_WASH_TIMESAVE_W"
...
class WasherStatus(object):
    ...
    def rinse_option_state (self):
        rinseoption = self.lookup_enum('RinseOption')
        if rinseoption == '-':
            return 'OFF'
        return WASHERRINSEOPTION(rinseoption)

    @property
    def wash_option_state (self):
        wash_option = self.lookup_enum('Wash')
        if wash_option == '-':
            return 'OFF'
        return WASHOPTION(wash_option)
